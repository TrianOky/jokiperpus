                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-warning my-1 my-md-0" onclick="edit('<?= $row['judul'] ?>','<?= $row['kategori'] ?>', '<?= $row['pengarang'] ?>', '<?= $row['penerbit'] ?>','<?= $row['tahun'] ?>', '<?= $row['id_buku'] ?>')">Edit</button>
                                            <button onclick="hapus(<?= $row['id_buku']; ?>)" class="btn btn-danger my-1 my-md-0">Hapus</button>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endwhile; ?>
